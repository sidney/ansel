...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    ...
    <html>
    <head>
    <title>documentation of anselrc</title>
    <style>
      html {
    ...
    <body>
      <div id="content">
      <div style="font-size: 42pt; font-weight: bold; color: white; text-align: right;">anselrc</div>
      <p>
        this files gives an overview over the default settings of the darktable configuration found in
        <span class="tt">~/.config/darktable/anselrc</span>.
        ...
        <a href="https://github.com/darktable-org/darktable/blob/master/data/anselconfig.xml.in">the corresponding source file</a> for up-to-date
        information.
      </p><br/>
      <table>
        <tr class="head_row">
