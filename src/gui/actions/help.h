static void show_about_dialog()
{
  ...
  /*
  gtk_about_dialog_set_website(GTK_ABOUT_DIALOG(dialog), "https://liberapay.com/aurelienpierre");
  gtk_about_dialog_set_website_label(GTK_ABOUT_DIALOG(dialog), _("Donate"));
  */
